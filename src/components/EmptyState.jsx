  ...
  return (
    ...
    >
      <div className="w-20 h-20 rounded-2xl bg-surface-hover flex items-center justify-center mx-auto mb-6">
        <Inbox size={40} className="text-[#52525B]" />
      </div>
      <h3 className="text-2xl font-semibold text-[#FAFAFA] mb-2">{title}</h3>
      <p className="text-base text-[#A1A1AA] mb-8 max-w-md mx-auto">{description}</p>
      {action && (
